...
background_image_path = r"C:\Users\ASUS\PycharmProjects\vaccine_pro\pythonProject1\data\82209535.webp"
...
pie_chart_btn = ttk.Button(info_frame, text="Show Vaccine Distribution Pie Chart",
